...
class AdminController extends Controller
{
  ...
  public function tipe_test()
  {
    ...
    $tipe = Tipe_test::leftjoin('tingkat', 'tipe_test.id_tingkat', '=', 'tingkat.id_tingkat')
                    ...
                    ->select('tipe_test.id_tingkat','tipe_test.id_tipetest','tipe_test.tipe_test', 'tingkat.nama_tingkat', 'tipe_test.setup_timer', 'tipe_test.menit')
  ...
  public function soal()
  {
    ...
    $soal = Soal::leftjoin('nomor_master_soal', 'tb_soal.id_nomormaster', '=', 'nomor_master_soal.id_nomormaster')
                ...
                ->select('tb_soal.id_soal','tb_soal.id_nomormaster','tb_soal.id_tipetest','tb_soal.id_tingkat','nomor_master_soal.nomor_master_soal', 'tipe_test.tipe_test', 'tingkat.nama_tingkat', 'tb_soal.nomor', 'tb_soal.soal')
  ...
  public function jawaban()
  {
    ...
    $jwbn = Jawaban::join('tb_soal', 'tb_jawaban.id_soal', '=', 'tb_soal.id_soal')
                  ...
                  ->select('tipe_test.tipe_test','tingkat.nama_tingkat','tb_soal.id_soal','tb_jawaban.id_jawaban','tb_soal.soal', 'nomor_master_soal.nomor_master_soal', 'tb_jawaban.opsi', 'tb_jawaban.jawaban', 'tb_jawaban.b_s')
                  ->get();
  ...
  public function pilih_master(Request $request)
  {
    ...
    $soal = Soal::join('nomor_master_soal', 'tb_soal.id_nomormaster', '=', 'nomor_master_soal.id_nomormaster')
                ...
                ->where('tb_soal.status', 'ACTIVE')
                ->select('tb_soal.soal', 'tb_soal.id_soal', 'nomor_master_soal.nomor_master_soal', 'tingkat.nama_tingkat', 'tipe_test.tipe_test')
                ->get();
  ...
  {
    $hasil = Jawaban_peserta::join('tipe_test', 'tb_jawabanpeserta.id_tipetest', '=', 'tipe_test.id_tipetest')
                            ->join('tingkat', 'tipe_test.id_tingkat', '=', 'tingkat.id_tingkat')
                            ->where('tb_jawabanpeserta.id_peserta', $id)
                            ->where('tb_jawabanpeserta.ket_bs', 'B')
                            ->select(DB::raw('COUNT(tb_jawabanpeserta.ket_bs) as jml_bs'), 'tb_jawabanpeserta.id_tipetest')
                            ->groupBy('tb_jawabanpeserta.id_tipetest')
                            ->get();

    $hasil1 = Jawaban_peserta::join('tipe_test', 'tb_jawabanpeserta.id_tipetest', '=', 'tipe_test.id_tipetest')
                            ->join('tingkat', 'tipe_test.id_tingkat', '=', 'tingkat.id_tingkat')
                            ->where('tb_jawabanpeserta.id_peserta', $id)
                            //->where('tb_jawabanpeserta.ket_bs', 'B')
                            ->select(DB::raw('COUNT(tb_jawabanpeserta.ket_bs) as jml_bs1'), 'tb_jawabanpeserta.id_tipetest', 'tingkat.nama_tingkat','tipe_test.tipe_test', 'tb_jawabanpeserta.id_peserta')
                            ->groupBy('tb_jawabanpeserta.id_tipetest', 'tingkat.nama_tingkat','tipe_test.tipe_test','tb_jawabanpeserta.id_peserta')
                            ->get();
    ...
    return view ('admin/hasil/cek_ujian', compact('hasil','hasil1','jawab','id'));
  }
