...
<section class="content">
    <div class="card">
        ...
        <form action="{{url('save_pestes_psi')}}" method="post">
            {{ csrf_field() }}
            <div class="card-body">
            ...
            <div class="box-footer">
                {{-- <div class="col-xs-4">
                    <div class="form-group">
                        <label><font color = "red-text">*</font>Masukan Tanggal Test</label>
                        <input type="text" class="form-control pull-right" name="tgl_test" id="datepicker" value="{{old('tgl_test')}}" placeholder="Masukan Tanggal Tes" required>
                    </div><br><br>
                </div> --}}
                {{-- <div class="col-xs-4">
                    <div class="form-group">
