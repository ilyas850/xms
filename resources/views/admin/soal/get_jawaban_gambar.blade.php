...
@section('content')
  ...
  <div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{url('save_jawaban_gambar')}}" enctype="multipart/form-data">
          {{ csrf_field() }}
        <div class="col-6">
            <?php $no=1; ?>
            @foreach ($soal as $key)
              <table width="100%">
                ...
                <tr>
                  <td colspan="3">
                    <img src="{{asset('Soal_gambar/'.$key->gambar)}}" alt="Image" width="500px" height="200px">
                  </td>
                </tr>
                <tr>
                  ...
                  <td><input type="file" name="jawab_gambar[]"></td>
                </tr>
                <tr>
