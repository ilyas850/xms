...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      {{-- <h1 class="logo me-auto"><a href="/home">XMS</a></h1> --}}
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1>XMS</h1>
          <h2>Xinergi Management System</h2>
          <div class="d-flex justify-content-center justify-content-lg-start">
            {{-- @if (Route::has('login'))
                    ...
                    @endauth
            @endif --}}
            <a href="{{ url('login_xms') }}" class="btn-get-started scrollto">Login</a>
  ...
  <footer id="footer">
    ...
    <div class="container footer-bottom clearfix">
      <div class="copyright">
        &copy; Copyright <strong><span>XMS</span></strong>. All Rights Reserved
      </div>
      {{-- <div class="credits">
